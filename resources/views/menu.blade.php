            ...
            <div class="flex-w flex-sb-m p-b-52">
                ...
                <div class="dis-none panel-search w-full p-t-10 p-b-15">
                    <div class="bor8 dis-flex p-l-15">
                        <a class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04">
                            <i class="zmdi zmdi-search"></i>
                        </a>

                        <input autocomplete="off" class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="keywords_submit" id="keywords" placeholder="Tìm kiếm...">
                    </div>
                    <div id="search_ajax" style="width: 100%""></div>
