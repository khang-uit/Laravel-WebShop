                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2">
							{!! \App\Helpers\Helper::price($product->price, $product->price_sale) !!} đồng
						</span>
                            ...
                            <div class="row">
                                <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <!-- Add review -->
                                        <form action="{{ route('addreview') }}" class="w-full" method="POST">
                                            @csrf
                                            ...
                                            <p class="stext-102 cl6">
Nhập email của bạn là bắt buộc                                            </p>
                                            ...
                                            <input type="hidden" class="size-111 bor8 stext-102 cl2 p-lr-20" value="{{ $product->id }}" name="product_id">
