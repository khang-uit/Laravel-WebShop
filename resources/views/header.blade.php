<header>
            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li>
                            <a href="/dashboard">Tìm cửa hàng</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="menu-mobile">
        <ul class="main-menu-m">
            ...
            <li>
                <a href="/dashboard.html">Tìm cửa hàng</a>
            </li>
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15" action="{{ route('search') }}" method="GET">
                ...
                <input class="plh3" autocomplete="off" name="keywords_search" placeholder="Tìm kiếm sản phẩm...">
            </form>
        </div>
    </div>
</header>
