                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        ...
                                        <input type="hidden" value="{{$total}}" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="total" placeholder="Email Liên Hệ">
                            ...
                            <button type="submit" name="redirect" formaction="{{ route('vnpay_payment') }}" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer m-t-10">
